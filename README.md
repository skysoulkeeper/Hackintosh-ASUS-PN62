...
Tested with Catalina and Big Sur. If you want Catalina, change kext AirportItlwm with Catalina support.
...
| iGPU          | Intel® UHD Graphics                                          | 0x3E9B                         | Used with HDMI output for TV                                 |
...
| Sound card    | Realtek® ALC3236-VB2/ALC255                                  | 0x9D74                         | HDMI, AudioJack working without problem. For alternative sound control with HDMI support, i use [SoundSource](https://rogueamoeba.com/soundsource/) application|
